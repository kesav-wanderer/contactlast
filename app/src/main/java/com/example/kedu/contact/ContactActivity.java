    ...
    private void initclearbutton() {
        ...
        clear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText add=(EditText)findViewById(R.id.editAddress);
                ...
                EditText home=(EditText)findViewById(R.id.editHome);
                EditText cell=(EditText)findViewById(R.id.editCell);
                EditText email=(EditText)findViewById(R.id.editEMail);
                TextView dob=(TextView) findViewById(R.id.textBirthday);
                name.setText("");
                add.setText("");
                city.setText("");
                state.setText("");
